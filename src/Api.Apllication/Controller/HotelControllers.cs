...
namespace Api.Apllication.Controller
{
    ...
    public class HotelController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult> Post ([FromServices] IHotelService _service, [FromBody] HotelEntity hotel)
        {
            if (!ModelState.IsValid)
            {
        ...
        [HttpPut]
        public async Task<ActionResult> Put([FromServices] IHotelService _service, [FromBody] HotelEntity hotel)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
